...
// finish terminates the third progress line without consuming the blank
// separator that belongs between the completed progress block and the next
// user-interface section.
func (p *progressBlockRenderer) finish() {
	if !p.active {
		return
	}
	fmt.Println()
